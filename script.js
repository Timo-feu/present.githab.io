class Snow{    
    ...
    Update(){
        ...
        this.x= this.x + (Math.floor(this.y / 40) % 2 * 0.1) - (Math.floor(this.y / 60) % 2 * 0.1);
...
const phrases = [
    ['Китайский Новый год',
        `Китайский Новый год, или Праздник весны (Чуньцзе) — главный традиционный праздник в Китае и странах Восточной Азии. Его дата рассчитывается по лунному календарю, выпадая на период между 21 января и 21 февраля. 
        Празднования длятся 15 дней и завершаются Фестивалем фонарей.
        История праздника насчитывает около трёх тысяч лет. Считается, что традиция зародилась во времена династии Шан когда в начале года люди приносили жертвы богам и предкам.`],
    ['Традиции',
        `•В Китае принято украшать дома в красных цветах: фонарики, вывески, парные надписи дуйцзы.
        •Запуск фейерверков и петард символизирует изгнание злых духов и привлечение удачи
