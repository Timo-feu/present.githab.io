...
const phrases = [
    ...
    Празднования длятся 15 дней и завершаются Фестивалем фонарей.
    История праздника насчитывает около трёх тысяч лет. Считается, 
    что традиция зародилась во времена династии Шан когда в начале года люди приносили жертвы богам и предкам.`],
    ['Традиции',
        ...
        •В день праздника или сразу после него родственники и друзья собираются за ужином за большим столом, 
        а так же дарят друг-другу подарки`
    ],
    ['Блюда',
        `В праздник на стол ставят блюда, которые несут символическое значение. 
         Например, цзяоцзы (китайские пельмени) символизируют богатство и процветание, а рыба – изобилие`
    ],
    ['Подарки',
        `Традиционный подарок на китайский новый год – красный конверт с деньгами (хунбао). 
        Их дарят детям и молодёжи как символ благополучия и удачи. Также популярны подарки в виде фруктов, например мандаринов, 
        и сладостей. Часы и ножи дарить не стоит – они ассоциируются с разлукой`
    ],
    ['Символ',
